...
public:
  ...
  //virtual int getPacket(lslidar_ch_msgs::LslidarN301Packet* pkt, const double time_offset) = 0;
  virtual int getPacket(lslidar_n301_msgs::LslidarN301PacketPtr& packet) = 0;
...
public:
  ...
  //virtual int getPacket(lslidar_ch_msgs::LslidarN301Packet* pkt, const double time_offset);
  virtual int getPacket(lslidar_n301_msgs::LslidarN301PacketPtr& packet);
...
public:
    ...
    virtual ~InputPCAP();
    virtual int getPacket(lslidar_n301_msgs::LslidarN301PacketPtr& pkt);
private:
