...
public:
  ...
  virtual int getPacket(lslidar_ch_msgs::LslidarChPacketPtr& packet,std::string packet_name) = 0;
...
public:
  ...
  virtual int getPacket(lslidar_ch_msgs::LslidarChPacketPtr& packet,std::string packet_name);
