...
public:
  ...
  virtual int getPacket(lslidar_ch128_msgs::LslidarChPacketPtr& packet) = 0;
...
public:
  ...
  virtual int getPacket(lslidar_ch128_msgs::LslidarChPacketPtr& packet);
...
public:
    ...
    virtual ~InputPCAP();
    virtual int getPacket(lslidar_ch128_msgs::LslidarChPacketPtr& pkt);
private:
