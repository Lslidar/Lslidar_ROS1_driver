...
#include "lslidar_n301_driver/LslidarPacket.h"
 ...
 */
    ...
    public:
        ...
        virtual int getPacket(lslidar_n301_driver::LslidarPacketPtr &pkt) = 0;
...
/** @brief Live lslidar input from socket. */
    ...
    public:
        ...
        virtual int getPacket(lslidar_n301_driver::LslidarPacketPtr &pkt);
