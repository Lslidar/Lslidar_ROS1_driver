...
#include <lslidar_ch128_msgs/LslidarChPacket.h>
#include <lslidar_ch128_msgs/LslidarChPoint.h>
#include <lslidar_ch128_msgs/LslidarChScan.h>
#include <lslidar_ch128_msgs/LslidarChSweep.h>
#include <lslidar_ch128_msgs/LslidarChLayer.h>
...
private:
    ...
    void packetCallback(const lslidar_ch128_msgs::LslidarChPacketConstPtr& msg);
    // Publish data
    ...
    lslidar_ch128_msgs::LslidarChScanPtr sweep_data;
